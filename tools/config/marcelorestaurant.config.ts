...
import {InjectableDependency, Environments} from './marcelorestaurant.config.interfaces';
...
export class AppConfig {
  ...
  TOOLS_DIR            = 'tools';
  SEED_TASKS_DIR       = join(process.cwd(), this.TOOLS_DIR, 'tasks', 'marcelorestaurant');
  DOCS_DEST            = 'docs';
  DIST_DIR             = 'dist';
